...
gganimate::anim_save(
  "Employment_in_sport.gif", animated_world
)
...
get_animated_world_map <- function() {
  world_map <- ggplot(
    ...
    labs(
      x = "",
      y = "",
      title = "Employment in sport (Males)",
      subtitle = "Year: {as.integer(current_frame)}",
      caption = "©2023 Sport Business Lab Consultancy\nData: Eurostat"
    )
...
gganimate::anim_save(
  "Employment_in_sport_males.gif", animated_world
)
...
get_animated_world_map <- function() {
  world_map <- ggplot(
    ...
    labs(
      x = "",
      y = "",
      title = "Employment in sport (Females)",
      subtitle = "Year: {as.integer(current_frame)}",
      caption = "©2023 Sport Business Lab Consultancy\nData: Eurostat"
    )
...
gganimate::anim_save(
  "Employment_in_sport_females.gif", animated_world
)
