# EUROSTAT - Acquisti online di biglietti per eventi sportivi
...
get_animated_world_map <- function() {
  world_map <- ggplot(
    ...
    labs(
      x = "",
      y = "",
      title = "Internet purchases of tickets to sport events",
...
gganimate::anim_save(
  "Internet_purchases_tickets_to_sport_events.gif", animated_world
)
...
get_animated_world_map <- function() {
  world_map <- ggplot(
    ...
    labs(
      x = "",
      y = "",
      title = "Internet purchases of tickets to sport events (Males)",
      subtitle = "Year: {as.integer(current_frame)}",
      caption = "©2023 Sport Business Lab Consultancy\nData: Eurostat"
    )
...
gganimate::anim_save(
  "Internet_purchases_tickets_to_sport_events_males.gif", animated_world
)
...
get_animated_world_map <- function() {
  world_map <- ggplot(
    ...
    labs(
      x = "",
      y = "",
      title = "Internet purchases of tickets to sport events (Females)",
      subtitle = "Year: {as.integer(current_frame)}",
      caption = "©2023 Sport Business Lab Consultancy\nData: Eurostat"
    )
...
gganimate::anim_save(
  "Internet_purchases_tickets_to_sport_events_females.gif", animated_world
)
...
get_animated_world_map <- function() {
  world_map <- ggplot(
    ...
    labs(
      x = "",
      y = "",
      title = "Internet purchases of tickets to sport events (AGE 16 - 24)",
      subtitle = "Year: {as.integer(current_frame)}",
      caption = "©2023 Sport Business Lab Consultancy\nData: Eurostat"
    )
...
gganimate::anim_save(
  "Internet_purchases_tickets_to_sport_events_young.gif", animated_world
)
