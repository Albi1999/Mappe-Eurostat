# EUROSTAT - Time spent on Sports and outdoor activities
...
p <- ggplot() +
  ...
  labs(
    ...
    y = NULL,
    title = "Time spent on Sports and outdoor activities 2010",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "Mappe Eurostat/Time spent on Sports and outdoor activities_2010.png",
...
p <- ggplot() +
  ...
  labs(
    x = "Sport Business Lab Consultancy\nData: Eurostat",
    y = NULL,
    title = "Time spent on Sports and outdoor activities (MALES) 2010",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "Mappe Eurostat/Time spent on Sports and outdoor activities_(MALES)_2010.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
p <- ggplot() +
  ...
  labs(
    x = "Sport Business Lab Consultancy\nData: Eurostat",
    y = NULL,
    title = "Time spent on Sports and outdoor activities (FEMALES) 2010",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
