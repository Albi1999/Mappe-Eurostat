# EUROSTAT - Person attending live sport events in the last 12 months
...
p <- ggplot() +
  ...
  labs(
    ...
    y = NULL,
    title = "Person attending live sport events\nin the last 12 months - 2011",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "PARTECIPAZIONE_EVENTI_2011.png",
...
p <- ggplot() +
  ...
  labs(
    x = "Sport Business Lab Consultancy\nData: Eurostat",
    y = NULL,
    title = "Person attending live sport events\nin the last 12 months (MALES)- 2011",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "PARTECIPAZIONE_EVENTI_(MALES)_2011.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
p <- ggplot() +
  ...
  labs(
    x = "Sport Business Lab Consultancy\nData: Eurostat",
    y = NULL,
    title = "Person attending live sport events\nin the last 12 months (FEMALES) - 2011",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "PARTECIPAZIONE_EVENTI_(FEMALES)_2011.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
p <- ggplot() +
  ...
  labs(
    x = "Sport Business Lab Consultancy\nData: Eurostat",
    y = NULL,
    title = "Person attending live sport events\nin the last 12 months (AGE 25-34) - 2011",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "PARTECIPAZIONE_EVENTI_(AGE 25-34)_2011.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
ggsave(
  filename = "PARTECIPAZIONE_EVENTI_2007.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
p <- ggplot() +
  ...
  labs(
    x = "Sport Business Lab Consultancy\nData: Eurostat",
    y = NULL,
    title = "Person attending live sport events\nin the last 12 months (MALES) - 2007",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "PARTECIPAZIONE_EVENTI_(MALES)_2007.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
p <- ggplot() +
  ...
  labs(
    x = "Sport Business Lab Consultancy\nData: Eurostat",
    y = NULL,
    title = "Person attending live sport events\nin the last 12 months (FEMALES) - 2007",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "PARTECIPAZIONE_EVENTI_(FEMALES)_2007.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
p <- ggplot() +
  ...
  labs(
    x = "Sport Business Lab Consultancy\nData: Eurostat",
    y = NULL,
    title = "Person attending live sport events\nin the last 12 months (AGE 25-34) - 2007",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "PARTECIPAZIONE_EVENTI_(AGE 25-34)_2007.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
