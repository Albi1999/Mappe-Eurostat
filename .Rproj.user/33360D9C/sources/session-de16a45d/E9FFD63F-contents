# EUROSTAT - FREQUENZA PARTECIPAZIONE EVENTI (2006 - 2015)
...
p <- ggplot() +
  ...
  labs(
    ...
    y = NULL,
    title = "Frequency of participation in sports events\nin the last 12 month - 2015",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "FREQUENZA_PARTECIPAZIONE_EVENTI_2015.png",
...
ggsave(
  filename = "FREQUENZA_PARTECIPAZIONE_EVENTI_2015_(MALES).png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
ggsave(
  filename = "FREQUENZA_PARTECIPAZIONE_EVENTI_2015_(FEMALES).png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
ggsave(
  filename = "FREQUENZA_PARTECIPAZIONE_EVENTI_2015_(AGE: 16-29).png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
ggsave(
  filename = "FREQUENZA_PARTECIPAZIONE_EVENTI_2006.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
ggsave(
  filename = "FREQUENZA_PARTECIPAZIONE_EVENTI_2006_(FEMALES).png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
ggsave(
  filename = "FREQUENZA_PARTECIPAZIONE_EVENTI_2006_(AGE: 16-29).png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
