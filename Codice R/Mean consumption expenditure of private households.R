# EUROSTAT - Mean consumption expenditure of private households on sporting goods and services
...
p <- ggplot() +
  ...
  scale_fill_manual(
    name = "Purchasing power standard",
    values = cols,
    drop = F
  ) +
  ...
  labs(
    ...
    y = NULL,
    title = "Mean consumption expenditure of private households on\nsports goods and services - 2015",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "Mappe Eurostat/Mean consumption expenditure of private households on sports goods and services_2015.png",
...
p <- ggplot() +
  ...
  labs(
    x = "Sport Business Lab Consultancy\nData: Eurostat",
    y = NULL,
    title = "Mean consumption expenditure of private households on\nsports goods and services - 2010",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "Mappe Eurostat/Mean consumption expenditure of private households on sports goods and services_2010.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
ggsave(
  filename = "Mappe Eurostat/Mean consumption expenditure of private households on equipment for sport_2015.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
p <- ggplot() +
  ...
  labs(
    x = "Sport Business Lab Consultancy\nData: Eurostat",
    y = NULL,
    title = "Mean consumption expenditure of private households on\nrecreational and sporting services - 2015",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "Mappe Eurostat/Mean consumption expenditure of private households on recreational and sporting services_2015.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
p <- ggplot() +
  ...
  labs(
    x = "Sport Business Lab Consultancy\nData: Eurostat",
    y = NULL,
    title = "Mean consumption expenditure of private households on\nrecreational and sporting services - 2010",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "Mappe Eurostat/Mean consumption expenditure of private households on recreational and sporting services_2010.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
