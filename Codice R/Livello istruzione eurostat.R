...
# 5. MAP
#-------
cols <- c('#d40000', '#d35413', '#ce7d27', '#c5a03b', '#b6c250', '#9fe265', "#cacaca")
...
p <- ggplot() +
  ...
  scale_fill_manual(
    name = "Percentage of total polulation",
    values = cols,
    drop = F
  ) +
  ...
  labs(
    ...
    y = NULL,
    title = "Persons with tertiary education\n2021",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "Scienza_tecnologia_2021.png",
