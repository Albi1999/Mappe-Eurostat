# EUROSTAT - Time spent on health-enhancing, aerobic and physical activity
...
p <- ggplot() +
  ...
  labs(
    ...
    y = NULL,
    title = "Time spent on health-enhancing, aerobic and physical activity\n Zero minutes - 2019 ",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "Mappe Eurostat/Time spent on health-enhancing, aerobic and physical activity_Zero minutes_2019.png",
...
ggsave(
  filename = "Mappe Eurostat/Time spent on health-enhancing, aerobic and physical activity_From 1 to 149 minutes_2019.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)


## From 150 to 299 minutes ----
# get NUTS2-level data
get_eurostat_data <- function() {
  eurostat_df <- eurostat::get_eurostat(
    "hlth_ehis_pe2e",
...
ggsave(
  filename = "Mappe Eurostat/Time spent on health-enhancing, aerobic and physical activity_From 150 to 299 minutes_2019.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
ggsave(
  filename = "Mappe Eurostat/Time spent on health-enhancing, aerobic and physical activity_150 minutes or over_2019.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
...
ggsave(
  filename = "Mappe Eurostat/Time spent on health-enhancing, aerobic and physical activity_300 minutes or over_2019.png",
  width = 7, height = 8.5, dpi = 600,
  device = "png", bg = "white", p
)
