...
get_enriched_table <- function() {
  ...
  enriched_df <- wide_df |>
    dplyr::mutate(values = if_else(is.na(`2022`), `2022`, `2022`)) |>
...
# 5. MAP
#-------
cols <- c('#d8eaa5', '#e0bd65', '#d19345', '#be6b2b', '#a94114', '#910000', "#cacaca")
