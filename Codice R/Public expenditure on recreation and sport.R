# EUROSTAT - Public expenditure on recreation and sport
...
p <- ggplot() +
  ...
  labs(
    ...
    y = NULL,
    title = "Public expenditure on recreation and sport - 2021",
    subtitle = ""
  ) +
  theme_minimal() +
  theme(
...
ggsave(
  filename = "Mappe Eurostat/Public expenditure on recreation and sport_2021.png",
